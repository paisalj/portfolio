    ...
    <div class="admin-projects-container">
        ...
        <div class="admin-project-form-header">
            ...
            <div>
                ...
                <p>
                    Perbarui informasi project pada portfolio.
                </p>
            </div>
        ...
        >
            ...
            <div class="admin-project-form-section">
                ...
                <div class="admin-project-form-grid">
                    ...
                    <div class="admin-project-form-group">
                        ...
                        <small>
                            Digunakan sebagai identitas URL project.
                        </small>
            ...
            <div class="admin-project-form-section">
                ...
                <div class="admin-project-section-title">
                    ...
                    <div>
                        ...
                        <p>Perbarui screenshot atau gambar project.</p>
                    </div>
                ...
                @if($project->image)
                    ...
                    <div class="admin-project-current-image">
            ...
            <div class="admin-project-form-section">
                ...
                <div class="admin-project-section-title">
                    ...
                    <div>
                        <h2>Link Project</h2>
                        <p>Repository dan demo project.</p>
                    </div>
