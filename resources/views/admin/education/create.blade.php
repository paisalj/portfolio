...
@section('admin-title', 'Tambah Education')
    ...
    <div class="admin-education-container">
        ...
        <div class="admin-education-form-header">
            ...
            <div>
                ...
                <p>
                    Tambahkan riwayat pendidikan ke portfolio.
                </p>
            </div>
            ...
            <div class="admin-education-form-section">
                ...
                <div class="admin-education-section-title">
                    ...
                    <div>
                        ...
                        <p>
                            Masukkan informasi utama pendidikan.
                        </p>
                    </div>
            ...
            <div class="admin-education-form-section">
                ...
                <div class="admin-education-section-title">
                    ...
                    <div>
                        ...
                        <p>
                            Tentukan tanggal mulai dan selesai pendidikan.
                        </p>
                    </div>
